...
const DigitalHub = () => {
  ...
  const features = [
    {
      ...
      title: t("digitalHub.features.marketplace.title"),
      desc: t("digitalHub.features.marketplace.desc"),
    },
    {
      icon: <Smartphone className="h-10 w-10 text-green-600" />,
      title: t("digitalHub.features.mobile.title"),
      desc: t("digitalHub.features.mobile.desc"),
    },
    {
      icon: <BarChart3 className="h-10 w-10 text-green-600" />,
      title: t("digitalHub.features.analytics.title"),
      desc: t("digitalHub.features.analytics.desc"),
    },
    {
      icon: <Users className="h-10 w-10 text-green-600" />,
      title: t("digitalHub.features.community.title"),
      desc: t("digitalHub.features.community.desc"),
    },
    {
      icon: <Cloud className="h-10 w-10 text-green-600" />,
      title: t("digitalHub.features.training.title"),
      desc: t("digitalHub.features.training.desc"),
    },
    {
      icon: <Sprout className="h-10 w-10 text-green-600" />,
      title: t("digitalHub.features.organic.title"),
      desc: t("digitalHub.features.organic.desc"),
    },
    {
      icon: <Tractor className="h-10 w-10 text-green-600" />,
      title: t("digitalHub.features.smartFarming.title"),
      desc: t("digitalHub.features.smartFarming.desc"),
    },
    {
      icon: <Wifi className="h-10 w-10 text-green-600" />,
      title: t("digitalHub.features.iot.title"),
      desc: t("digitalHub.features.iot.desc"),
    },
    {
      icon: <BookOpen className="h-10 w-10 text-green-600" />,
      title: t("digitalHub.features.knowledge.title"),
      desc: t("digitalHub.features.knowledge.desc"),
    },
    {
      icon: <ShieldCheck className="h-10 w-10 text-green-600" />,
      title: t("digitalHub.features.certification.title"),
      desc: t("digitalHub.features.certification.desc"),
    },
  ];
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-12">
      <Helmet>
        <title>{t("seo.digitalHub.title")}</title>
        <meta name="description" content={t("seo.digitalHub.description")} />
        <meta name="keywords" content={t("seo.digitalHub.keywords")} />
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {socials.map((social, idx) => (
          <a key={idx} href={social.link} rel="noopener noreferrer">
